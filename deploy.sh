...
echo "8347142212:AAGN_lTlBiT0PewaLoAJ23NG2b2Y2rWxNyI" | npx wrangler secret put TELEGRAM_BOT_TOKEN
...
curl "https://api.telegram.org/bot8347142212:AAGN_lTlBiT0PewaLoAJ23NG2b2Y2rWxNyI/setWebhook?url=$WORKER_URL"
